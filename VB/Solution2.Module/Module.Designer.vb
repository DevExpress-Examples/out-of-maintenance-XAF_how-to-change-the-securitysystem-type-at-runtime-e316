...
Namespace Solution2.Module
	Partial Public Class Solution2Module
		...
		Private Sub InitializeComponent()
			...
			' Solution2Module
			' 
			Me.AdditionalBusinessClasses.Add(GetType(DevExpress.Persistent.BaseImpl.BasicUser))
			Me.AdditionalBusinessClasses.Add(GetType(DevExpress.Persistent.BaseImpl.User))
